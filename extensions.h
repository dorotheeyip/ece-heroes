...
void joker(int plateau[N][P], int ligne, int colonne, int type); // ajout type
// Remplace l'item d'une case choisie par le joueur par un item normal de son choix 


int detecter_diagonale4(int plateau[N][P], int *ligne, int *colonne, int *orientation); //ajout orientation 1=vers droite 2=vers gauche
...
void effet_diagonale4(int plateau[N][P], int ligne, int colonne, int orienttion); //ajout orientation 1=vers droite 2=vers gauche
...
void effet_ligne7(int plateau[N][P], int ligne, int colonne, int orientation); // ajout orientation 1=verticale 0=horizontale
